    ...
    switch(this.mLevel){
        case 6:{
            ...
            if(this.level6 !== null)
            {
                ...
                this.mMsg2.getXform().setPosition(700,200);
        ...
        case 5:{
            ...
            this.levelset.addToSet(this.msg6);
                ...
                this.mMsg = new FontRenderable("to be continued...");
                this.mMsg.setColor([1,1,1, 1]);
                this.mMsg.getXform().setPosition(300,100);
                this.mMsg.setTextHeight(20);
                this.msgset.addToSet(this.mMsg);
